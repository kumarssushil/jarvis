...
def wish():
    ...
    if hour >= 0 and hour<12:
        speak("good morning boss i am jarvis")
    elif hour>=12 and hour<18:
        speak("good afternoon boss i am jarvis") 
    else:
...
#     server.ehlo()
#     server.starttls()
#     server.login('kumar57@gmail.com', '-')
#     server.sendmail('kumar557@gmail.com', to, content)
#     server.close()
...
if __name__ == "__main__":
    ...
    while True:
        ...
        if 'who make you' in query or 'who created you' in query or 'who develop you' in query:
            ans_m = " For your information sk Created me"
            print(ans_m)
            speak(ans_m)

        elif 'who' in query or 'what' in query:
            speak("boss i am searching for details please give me a second.")
            query.replace("wikipedia", "")
            results = wikipedia.summary(query, sentences=2)
            print(results)
            speak(results)
        ...
        elif 'tell about myself' in query:
            speak("Sir you are the founder of sk industries")  
        elif 'get started' in query:
            speak("sir, there are multiple contrusions detected are you going to fix them")  
